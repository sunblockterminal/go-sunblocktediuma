Name "gsbt ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/sunblockterminal/go-sunblocktediuma/issues"
!define UPDATEURL "https://github.com/sunblockterminal/go-sunblocktediuma/releases"
!define ABOUTURL "https://github.com/sunblockterminal/go-sunblocktediuma#ethereum-go"
...
# Install gsbt binary
Section "Gsbt" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gsbt}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gsbt.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gsbt.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gsbt incoming peers (TCP:33560)" ""  6 1 1 2147483647 1 "$INSTDIR\gsbt.exe" "" "" "Ethereum" 33560 "" "" ""
  SimpleFC::AdvAddRule "Gsbt outgoing peers (TCP:33560)" ""  6 2 1 2147483647 1 "$INSTDIR\gsbt.exe" "" "" "Ethereum" "" 33560 "" ""
  SimpleFC::AdvAddRule "Gsbt UDP discovery (UDP:33560)" "" 17 2 1 2147483647 1 "$INSTDIR\gsbt.exe" "" "" "Ethereum" "" 33560 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gsbt.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gsbt.ipc"
