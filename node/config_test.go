...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gsbt.ipc", false, filepath.Join(os.TempDir(), "gsbt.ipc")},
		{"data", "gsbt.ipc", false, "data/gsbt.ipc"},
		{"data", "./gsbt.ipc", false, "./gsbt.ipc"},
		{"data", "/gsbt.ipc", false, "/gsbt.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gsbt.ipc", true, `\\.\pipe\gsbt.ipc`},
		{"data", "gsbt.ipc", true, `\\.\pipe\gsbt.ipc`},
		{"data", `\\.\pipe\gsbt.ipc`, true, `\\.\pipe\gsbt.ipc`},
	}
